...
class Book extends Model
{
    ...
    public function scopeTitle(Builder $query, string $key): Builder|QueryBuilder
    {
    ...
    protected function dateRangeFilter(Builder $query, $from = null, $to = null)
    {
        if ($from && !$to) {
    ...
    {
        return $query->highestRated(now()->subMonth())
            ->withReviewsCount(now()->subMonth())
            ->minReviews(2);
    }
